...
BOT_ICON_URL = os.getenv(
    "BOT_ICON_URL",
    "https://i.imgur.com/TbZwQch.png"  # Replace with your hosted crest image
)

# ============================================================
# COLORS (hex ints, used directly in discord.Color)
# ============================================================
EMBED_COLOR = 0x87CEEB    # Neutral dark embed color (matches Discord dark theme)
SUCCESS_COLOR = 0x87CEEB  # Green
ERROR_COLOR =   0x800000  # Red
WARNING_COLOR = 0xFFD700  # Yellow
...
# ============================================================
VERIFICATION_PANEL_TITLE = "BRITISH ARMY VERIFICATION SYSTEM V1"
